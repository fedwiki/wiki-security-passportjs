...
The properties we need to add for Login to View are: `restricted`, `details`, and either `allowed_domains` or `allowed_usernames` depending on your identity provider.
...
```json
{
  ...
  "wikiDomains": {
    "private.example.com": {
      "admin": {"google":"105396921212328672315"},
      "google_clientID": "1003042997443-gcemshdl37j67mgpm99eu5dh43li5vrs.apps.googleusercontent.com",
      "google_clientSecret": "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",
      "restricted": true,
